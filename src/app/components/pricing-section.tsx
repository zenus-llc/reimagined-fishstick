            ...
            <div className="flex-1 max-w-full md:max-w-none self-stretch px-6 py-5 border border-[rgba(50,45,43,0.12)] border-[#E0DEDB] overflow-hidden flex flex-col justify-start items-start gap-12 bg-[rgba(255,255,255,0)]">
              ...
              <div className="self-stretch flex flex-col justify-start items-center gap-9">
                ...
                <div className="self-stretch px-4 py-[10px] relative bg-[#37322F] shadow-[0px_2px_4px_rgba(55,50,47,0.12)] overflow-hidden rounded-[99px] flex justify-center items-center">
                  ...
                  <button className="relative w-full max-w-[160px] px-6 py-[10px] bg-[#37322F] text-[#FBFAF9] text-[13px] font-medium leading-5 font-sans rounded-full shadow-[0px_2px_4px_rgba(55,50,47,0.12)] overflow-hidden flex justify-center items-center transition-all duration-300 hover:opacity-90 hover:scale-[1.02]">
  <div className="absolute inset-0 bg-gradient-to-b from-[rgba(255,255,255,0.20)] to-[rgba(0,0,0,0.10)] mix-blend-multiply rounded-full"></div>
  <span className="relative z-10"><Link href="/sign-up">Start for free</Link></span>
            ...
            <div className="flex-1 max-w-full md:max-w-none self-stretch px-6 py-5 bg-[#37322F] border border-[rgba(50,45,43,0.12)] border-[rgba(55,50,47,0.12)] overflow-hidden flex flex-col justify-start items-start gap-12">
              ...
              <div className="self-stretch flex flex-col justify-start items-center gap-9">
               ...
               <button
  type="button"
  className="self-stretch px-4 py-[10px] relative bg-[#FBFAF9] shadow-[0px_2px_4px_rgba(55,50,47,0.12)] overflow-hidden rounded-[99px] flex justify-center items-center hover:opacity-90 transition-opacity"
>
  ...
  <div className="max-w-[108px] flex justify-center flex-col text-[#37322F] text-[13px] font-medium leading-5 font-sans relative z-10">
   <Link href="/sign-up">Get Started</Link>
            ...
            <div className="flex-1 max-w-full md:max-w-none self-stretch px-6 py-5 bg-white border border-[#E0DEDB] overflow-hidden flex flex-col justify-start items-start gap-12">
              ...
              <button
  type="button"
  className="self-stretch px-4 py-[10px] relative bg-[#37322F] shadow-[0px_2px_4px_rgba(55,50,47,0.12)] overflow-hidden rounded-[99px] flex justify-center items-center hover:opacity-90 transition-opacity"
>
  <div className="w-full h-[41px] absolute left-0 top-[-0.5px] bg-gradient-to-b from-[rgba(255,255,255,0.20)] to-[rgba(0,0,0,0.10)] mix-blend-multiply"></div>
